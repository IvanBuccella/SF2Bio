...
\begin{figure}[htbp]
		...
		\caption{logP optimization on jupyter notebook}
		\label{fig:logp-optimization}
	\end{figure}

In the figure \ref{fig:logp-optimization} is reported the configured jupyter notebook of the execution described in the following sections; it can be reached by visiting the \href{http://localhost:{HTTP_PORT}/LogP_optimization_demo.ipynb}{URL} into the host machine web browser.
